...
import os
import sys
path = r'D:\编程教程\机器学习与深度学习\deep-learning\myenv\Lib\site-packages\PyQt5\Qt5\plugins\platforms'
...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        #模型初始化
        self.model = tf.keras.models.load_model("D:\编程教程\机器学习与深度学习\deep-learning\models\moilenetv2_new.keras")
        self.to_predict_name ='images\tmp_up.jpg'
        self.class_names = ['兔子','牛','狗狗','猪','猫猫','羊','马','鲨鱼','鸡'] #todo修改类名,这个数组在模型训练的开始会输出
        self.resize=(900,700)
        self.initUI()
    ...
    def initUI(self):
        ...
        cv2.imwrite('D:\编程教程\机器学习与深度学习\deep-learning\images\show.png',img_show)
        img_init = cv2.resize(img_init,(224,224))
        cv2.imwrite('D:\编程教程\机器学习与深度学习\deep-learning\images\target.png',img_init)
        self.img_label.setPixmap(QPixmap("D:\编程教程\机器学习与深度学习\deep-learning\images\show.png"))
        ...
        about_img = QLabel()
        about_img.setPixmap(QPixmap('D:\编程教程\机器学习与深度学习\deep-learning\images\show.png'))
        about_img.setAlignment(Qt.AlignCenter)
        label_super = QLabel("作者:黄昏") #todo 更换作者信息
        ...
        self.setTabIcon(0,QIcon('D:\编程教程\机器学习与深度学习\deep-learning\images\主页面.png'))
        self.setTabIcon(1,QIcon('D:\编程教程\机器学习与深度学习\deep-learning\images\关于.png'))
    ...
    def predict_img(self):
        img = Image.open('D:\编程教程\机器学习与深度学习\deep-learning\images\target.png')
